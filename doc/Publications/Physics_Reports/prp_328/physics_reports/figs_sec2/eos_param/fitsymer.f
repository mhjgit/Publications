...
!
            ...
            DO i=1,number_terms
               ...
               rho=rho+polynom_terms(i)*y**(0.33333333) 
            ENDDO
...
!
      ...
      write (6,*) number_of_data, number_terms                   
      ...
      ENDIF
      DO i=1,number_of_data
         WRITE(7,'(E10.4,2X,E10.4,2X,E10.4)') n(i), rho(n(i)), e(i)
      ENDDO
      ...
      DIMENSION afunc(ma)
      afunc(1)=(x/0.16)**(0.3333333333333)
      DO i=2,ma
         afunc(i)=afunc(i-1)*((x/0.16)**0.5)
      ENDDO
