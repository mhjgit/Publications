...
\affiliation{Gesellschaft f{\"u}r Schwerionenforschung (GSI),
D-64291 Darmstadt, Germany} \affiliation{Institut f\"{u}r
Kernphysik, Universit\"{a}t zu K{\"o}ln, D-50937 K{\"o}ln, Germany}
\author{H.~Geissel}
\affiliation{Gesellschaft f{\"u}r Schwerionenforschung (GSI),
D-64291 Darmstadt, Germany}
...
India} \affiliation{Gesellschaft f{\"u}r Schwerionenforschung (GSI),
D-64291 Darmstadt, Germany}
...
Delhi, India} \affiliation{Gesellschaft f{\"u}r Schwerionenforschung
...
\hline \hline
\end{tabular}
\footnotetext[1]{Ref.~\cite{ram01}} \footnotetext[2]{LSSM in a
($g_{7/2},d,s,h_{11/2}$) neutron space with $^{100}$Sn core}
\footnotetext[3]{LSSM in a proton ($g,d,s$) and neutron
($g_{7/2},d,s,h_{11/2}$) model space and a $^{90}$Zr core at t=4
(see text).} \footnotetext[4]{this work}
\footnotetext[5]{Ref.~\cite{rad04}}
\end{table}
...
\centering\mbox{\epsfig{file=fig2.eps,width=.45\textwidth}}
...
\centering\mbox{\epsfig{file=fig4.eps,width=.45\textwidth}}
