...
\put(3054,1846){\makebox(0,0)[r]{$\delta=10$ for N=11}}
\put(3054,1946){\makebox(0,0)[r]{$\delta=10$ for N=12}}
\put(2008,20){\makebox(0,0){Excitation energy $\langle E \rangle$}}
\put(100,1180){%
\special{ps: gsave currentpoint currentpoint translate
270 rotate neg exch neg exch translate}%
\makebox(0,0)[b]{\shortstack{Particle number $n$}}%
\special{ps: currentpoint grestore moveto}%
}
\put(3417,151){\makebox(0,0){0.2}}
\put(2713,151){\makebox(0,0){0.15}}
\put(2009,151){\makebox(0,0){0.1}}
\put(1304,151){\makebox(0,0){0.05}}
