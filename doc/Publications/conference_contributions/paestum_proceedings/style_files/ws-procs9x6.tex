...
\begin{table}[ph]
\tbl{First five normalized natural frequencies.}
{\footnotesize
\begin{tabular}{@{}crrrr@{}}
\hline
{} &{} &{} &{} &{}\\[-1.5ex]
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 
%Use this if your figures are put in a subdirectory having the same
%name as the main latex file, ie: 
%
%      ws-procs9x6/procs-fig1.eps      
%      ws-procs9x6/procs-fig2.eps      
%      ws-procs9x6/procs-fig3.eps      
%      ws-procs9x6/procs-fig4.eps      
%      etc.
%
%\begin{figure}[htbp] %ORIGINAL SIZE: width=1.4TRUEIN; height=1.5TRUEIN
%\figurebox{}{}{procf1} %100 percent
